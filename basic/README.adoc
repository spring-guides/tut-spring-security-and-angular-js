...
* All the CSS classes are from https://getbootstrap.com/[Twitter Bootstrap]. They will make things look pretty once we get the right stylesheets set up.

* The content in the greeting is an Angular component that we haven't defined yet (`<app/>`).
