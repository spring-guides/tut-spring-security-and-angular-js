...
* <<using-curl,Using curl on the command line>>
* <<using-spring-boot-cli,Using Spring Boot CLI>>
* <<using-the-initializr-website,Using the Spring Initializr website>>
* <<using-spring-tool-suite,Using Spring Tool Suite>>

The source code for the complete project we are going to build is in https://github.com/dsyer/spring-security-angular/tree/master/basic[Github here], so you can just clone the project and work directly from there if you want. Then jump to the <<add-a-home-page,next section>>.
